...
const services = [
  {
    ...
    description:
      "Modern teknolojilerle hızlı, güvenli ve ölçeklenebilir web uygulamaları geliştiriyoruz.",
    features: [
      ...
      "SEO Uyumlu Tasarım",
      "Responsive(Mobil ve PC Uyumlu) Tasarım",
      "Bakım ve Destek",
  ...
  },
  {
    ...
    description:
      "Altyapınızı buluta taşıyarak güvenli, esnek ve maliyet etkin sistemler kuruyoruz.",
    features: [
      "Cloud Migration",
      "DevOps",
      "Sistem Yönetimi",
  ...
  },
  {
    ...
    description:
      "İş süreçlerinizi dijitalleştirerek verimliliğinizi artırıyor ve rekabet gücünüzü güçlendiriyoruz.",
    features: [
      "Süreç Analizi",
      "Otomasyon",
      "Danışmanlık",
  ...
  },
  {
    ...
    description:
      "Sistemlerinizi birbirine bağlayarak sorunsuz veri akışı ve otomasyon sağlıyoruz.",
    features: [
      "REST API",
      "Mikroservis",
      "Sistem Entegrasyonu",
    ...
    <section id="services" className="py-20 lg:py-32 bg-white dark:bg-black">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl dark:text-white sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Profesyonel{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <Card
                key={index}
                className="dark:bg-[#111111] dark:border-[#292727] group hover:shadow-xl transition-all duration-300 border-2 hover:border-rose-200 hover:-translate-y-1"
              >
                <CardHeader>
