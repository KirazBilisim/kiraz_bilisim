    ...
    <footer className="bg-gray-900 dark:bg-black text-gray-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div>
            ...
            <p className="text-sm leading-relaxed mb-4">
              Teknoloji ile değer yaratan, müşteri memnuniyetini ön planda tutan
              ve yenilikçi çözümler sunan güvenilir iş ortağınız.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm">
                  Yakında fiziksel ofisimiz açılacaktır. Şimdilik online olarak
                  hizmet vermekteyiz.
                </span>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} Kiraz Bilişim. Tüm hakları
            saklıdır.
          </p>
        </div>
      </div>
