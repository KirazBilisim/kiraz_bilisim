...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-rose-50"
    >
      <div className="absolute inset-0 bg-grid-gray-900/[0.04] bg-[size:20px_20px] dark:bg-black" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold dark:text-white text-gray-900 mb-6 leading-tight animate-fade-in-up">
            Geleceği Kodlayan{" "}
          ...
          <p className="text-lg sm:text-xl dark:text-white text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-in-up animation-delay-200">
